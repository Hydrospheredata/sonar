...
import io.hydrosphere.sonar.common.terms.{Check, ProfileSourceKind}
import io.hydrosphere.sonar.common.utils.Logging
import io.hydrosphere.sonar.common.utils.checks.ProfileChecks
import io.hydrosphere.sonar.legacy.actors.SonarSupervisor
...
//  }
  override def analyze(request: ExecutionInformation): Future[Empty] = Future.successful(Empty())
}