package io.hydrosphere.sonar.legacy
...
import io.hydrosphere.sonar.legacy.actors.MetricSpecDiscoverer.DiscoveryMsg
import io.hydrosphere.sonar.common.config.Configuration
import io.hydrosphere.sonar.common.utils.{AutoODServiceRpc, GatewayServiceRpc, Logging}
import io.hydrosphere.sonar.legacy.endpoints.HttpService
